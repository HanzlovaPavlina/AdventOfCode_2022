...
namespace AdventOfCode_2022.Day_22 {
    ...
    class Walker_2D {
        ...
        public Walker_2D (int row, int col, int dir, char[,] map) {
            this.row = row;
            this.column = col;
            this.direction = dir;
            this.map = map;
    ...
    class MonkeyMap_2D {
        ...
        public MonkeyMap_2D(string path) {
        ...
        public int GetFinalPassword() {
            ...
            Walker_2D walker = new Walker_2D(0, startCol, 'R', map);
        ...
        void GoToEnd(Walker_2D walker, List<int> steps, List<char> rotations) {
